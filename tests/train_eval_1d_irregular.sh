...
DATA_PATH="${ROOT_DIR}/data/transolver_1d_irregular_n64.pt"
RUN_DIR="${ROOT_DIR}/runs/synth_1d_n64_q"
SAVE_NAME="synth_1d_n64_q"
BEST_CKPT="${RUN_DIR}/checkpoints/${SAVE_NAME}_best_eval.pt"
CONFIG_PATH="${ROOT_DIR}/tests/configs/train_eval_1d_irregular.yaml"
...
echo "[1/2] train 1D irregular synthetic cache with quadrature weights"
